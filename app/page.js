...
const LanguagesAndTools = () => (
  <Card title="Languages and Tools">
    ...
    <div className="flex flex-wrap items-center justify-center sm:justify-start gap-4 p-4 rounded-lg bg-white/5 border border-white/10">
      ...
      <a href="https://aws.amazon.com" target="_blank" rel="noreferrer"> <img src="https://raw.githubusercontent.com/devicons/devicon/54cfe13ac10eaa1ef817a343ab0a9437eb3c2e08/icons/amazonwebservices/amazonwebservices-plain-wordmark.svg" alt="aws" className="w-10 h-10" /> </a>
      ...
      <a href="https://mariadb.org/" target="_blank" rel="noreferrer"> <img src="https://raw.githubusercontent.com/devicons/devicon/54cfe13ac10eaa1ef817a343ab0a9437eb3c2e08/icons/mariadb/mariadb-original-wordmark.svg" alt="mariadb" className="w-10 h-10" /> </a>
      ...
      <a href="https://www.photoshop.com/en" target="_blank" rel="noreferrer"> <img src="https://raw.githubusercontent.com/devicons/devicon/54cfe13ac10eaa1ef817a343ab0a9437eb3c2e08/icons/photoshop/photoshop-plain.svg" alt="photoshop" className="w-10 h-10" /> </a>
      ...
      <div className="relative z-10">
        <div className="flex flex-col items-center justify-center min-h-screen p-4 text-center ">
          <div className="flex flex-col items-center justify-center h-full space-y-6 ">
            ...
            <nav className="sticky top-4 bg-white/10 backdrop-blur-lg z-30 py-4 mb-16 border border-white/20 transition-colors duration-300 rounded-2xl shadow-md w-3xl">
              ...
              {navItems.map((item) => (
                <li key={item.sectionId}>
                  <a
                    ...
                    className="font-medium text-gray-200 hover:text-white transition-colors duration-200 px-3 py-2 rounded-md"
                  >
                    {item.name}
                  </a>
                </li>
